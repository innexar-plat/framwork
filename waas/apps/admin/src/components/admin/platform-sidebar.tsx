...
export function PlatformSidebar() {
  ...
  return (
    <aside
      className="flex w-56 flex-col border-r border-[#1e2230] bg-[#111318]"
      aria-label="Platform sidebar"
    >
      <div className="flex h-14 items-center border-b border-[#1e2230] px-4">
        ...
        {NAV_ITEMS.map(({ href, labelKey, icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className={`flex items-center gap-3 rounded-md border-l-[3px] px-3 py-2 text-sm font-medium transition-colors ${
                isActive
                  ? "border-[#4f6ef7] bg-[rgba(79,110,247,0.12)] text-[#4f6ef7]"
                  : "border-transparent text-[#8892a4] hover:bg-[#181b23] hover:text-[#e8eaf0]"
              }`}
